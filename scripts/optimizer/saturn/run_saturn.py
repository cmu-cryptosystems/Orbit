...
if __name__ == "__main__":
    ...
    outname = f"saturn_{benchmark}_Lm{args.Lm}_Sw{args.Sw}" + ("_nobypass" if args.nobypass else "_bypass") + ("_qbp" if args.qbp else "_noqbp") + ("_nocomp" if args.nocomp else "_comp") + ("_nopart" if args.nopart else "_part")
