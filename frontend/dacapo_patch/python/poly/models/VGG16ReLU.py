...
class VGG16ReLU(nn.Module):
    def __init__(self):
        super(VGG16ReLU, self).__init__()
        ...
        if use_cuda :
            ...
            self.maxpool_5 = self.maxpool_5.cuda()
