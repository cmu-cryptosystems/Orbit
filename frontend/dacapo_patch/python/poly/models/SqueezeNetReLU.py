...
__all__ = ['SqueezeNetReLU', 'squeezenetrelu']
...
class SqueezeNetReLU(nn.Module):
    def __init__(self):
        super(SqueezeNetReLU, self).__init__()
